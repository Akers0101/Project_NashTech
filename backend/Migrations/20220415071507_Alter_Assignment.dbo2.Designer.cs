...
namespace backend.Migrations
{
    ...
    [Migration("20220415071507_Alter_Assignment.dbo2")]
    partial class Alter_Assignmentdbo2
    {
            ...
            modelBuilder.Entity("backend.Entities.Asset", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            CategoryId = 1,
                            CategoryName = "Laptop",
                            InstalledDate = new DateTime(2022, 4, 15, 14, 15, 6, 143, DateTimeKind.Local).AddTicks(6755),
                        ...
                        new
                        {
                            ...
                            InstalledDate = new DateTime(2022, 4, 15, 14, 15, 6, 143, DateTimeKind.Local).AddTicks(6773),
                            Location = "sample location",
                            Specification = "this is sample data"
                        },
                        new
                        {
                            ...
                            InstalledDate = new DateTime(2022, 4, 15, 14, 15, 6, 143, DateTimeKind.Local).AddTicks(6775),
                            Location = "sample location",
                            Specification = "this is sample data"
                        });
                });
            ...
            modelBuilder.Entity("backend.Entities.User", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            Gender = 0,
                            IsFirstLogin = true,
                            JoinedDate = new DateTime(2022, 4, 15, 14, 15, 6, 335, DateTimeKind.Local).AddTicks(9867),
                            LastName = "Quy Vuong",
                            Location = 0,
                            PasswordHash = "$2a$11$4pgGVVWJTkIlN/xfisqeRuHiV4/JYt.aNb278v9TZpg2mB49E1saW",
                            Role = 0,
                            StaffCode = "AD1",
                            UserName = "Admin",
                            UserState = 1
                        ...
                        new
                        {
                            ...
                            Gender = 0,
                            IsFirstLogin = true,
                            JoinedDate = new DateTime(2022, 4, 15, 14, 15, 6, 539, DateTimeKind.Local).AddTicks(7730),
                            LastName = "Chi Huong",
                            Location = 0,
                            PasswordHash = "$2a$11$5EHf2eOtDCguUNd6gpDB6.nVf.5yNN0/ZfV2Dq6jZGqG3ZFuzXeUW",
                            Role = 1,
                            StaffCode = "US2",
                            UserName = "Staff",
                            UserState = 1
                        ...
                        new
                        {
                            ...
                            Gender = 1,
                            IsFirstLogin = true,
                            JoinedDate = new DateTime(2022, 4, 15, 14, 15, 6, 735, DateTimeKind.Local).AddTicks(8320),
                            LastName = "Chi Huong",
                            Location = 1,
                            PasswordHash = "$2a$11$M6ix7m/rzUWTXwxvBRq9.eMVL2iWoZZN4KfEm4drv/Azbhdm902Fm",
                            Role = 1,
                            StaffCode = "........",
                            UserName = "Huong",
                            UserState = 0
