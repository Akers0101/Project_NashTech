          ...
          <Grid item xs={9}>
            <Routes>
              <Route element={<PrivateRoute />}>
                ...
                <Route path="/assignment/:id" element={<MyAssignmentDetail />} />
                ...
                <Route path="/assignment-list/create" element={<CreateAssignment />} />
                <Route path="/assignment-list/edit:id" element={<EditAssignment />} />
