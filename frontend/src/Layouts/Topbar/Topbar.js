...
function Topbar() {
  ...
  const handleClickShowPasswordold = () => setOldPasswordShown(!oldPasswordShown);
  const handleMouseDownPasswordold = () => setOldPasswordShown(!oldPasswordShown);
  ...
  useEffect(() => {
    setSubmitDisabled((data.oldPassword===''|| data.newPassword==='')?true:false);
            ...
            <div>
              <Dropdown>
               Hi, {user} 
                ...
                <Dropdown.Toggle variant="Danger" style={{color:'white'}} id={`dropdown-split-variants-basic`}/>

                <Dropdown.Menu variant="Danger">
                  <Dropdown.Item  onClick={()=> setOpenPopupchange(true)}>Change Password</Dropdown.Item>
                  <Dropdown.Item onClick={()=> setOpenPopup(true)}>Logout</Dropdown.Item>
                </Dropdown.Menu>
              </Dropdown>
            </div>
          )}
            ...
            InputProps={{  
              endAdornment: (
                <InputAdornment position="end">
                  ...
                  >
                    {oldPasswordShown ? <VisibilityIcon /> : <VisibilityOffIcon />}
                  </IconButton>
                </InputAdornment>)}}
          />
